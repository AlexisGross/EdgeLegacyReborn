//
// TabBarContainer.xaml.h
// Declaration of the TabBarContainer class
//

#pragma once

#include "CustomControls\TabBarContainer.g.h"
...
namespace MicrosoftEdgeLegacyReborn
{
	...
	public ref class CustomUserControls::TabBarContainer sealed
	{
	public:
