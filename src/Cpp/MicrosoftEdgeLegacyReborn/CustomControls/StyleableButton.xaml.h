//
// StyleableButton.xaml.h
// Declaration of the StyleableButton class
//

#pragma once

#include "CustomControls\StyleableButton.g.h"
...
namespace MicrosoftEdgeLegacyReborn
{
	...
	public ref class CustomUserControls::StyleableButton sealed
	{
	public:
